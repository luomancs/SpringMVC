				...
				<li class="text-center">
                    ...
                    <li>
                        <a  href="tab-panel.html"><i class="fa fa-qrcode fa-3x"></i> Tabs & Panels</a>
						   ...
						   <li  >
                        <a class="active-menu"   href="chart.jsp"><i class="fa fa-bar-chart-o fa-3x"></i> Morris Charts</a>
                    </li>	
                      <li  >
					...
					<li  >
                     ...
                     <li  >
                        <a   href="registration.jsp"><i class="fa fa-laptop fa-3x"></i> Registeration</a>
                    </li>	
