...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <h1>实验课 添加</h1>
            <hr/>
            <form:form action="tAddExperience" method="post" commandName="experience" role="form">
                <div class="row">
                    <div class="col-lg-6">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('确定提交实验课程？')">提交</button>
                </div>
            </form:form>
