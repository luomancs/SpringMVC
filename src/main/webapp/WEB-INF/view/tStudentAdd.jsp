...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <form:form action="addStudent" method="post" commandName="studentAdd" role="form">
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" id="institution" name="institution" ></textarea>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <textarea class="form-control" id="major" name="major" ></textarea>
                                            </td>
