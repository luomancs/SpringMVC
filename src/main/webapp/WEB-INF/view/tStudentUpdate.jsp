...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <form:form action="updateStudent${studentUpdate.id}" method="post" commandName="studentUpdate" role="form">
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" id="userName" name="userName" value ="${studentUpdate.userName}" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="password" name="password" value="${studentUpdate.password}"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <label for="institution">班级</label>
                                            </td>
                                            <td>
                                                <input class="form-control" id="institution" name="institution" value="${studentUpdate.institution}"/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-control" id="major" name="major" value="${studentUpdate.major}"/>
                                            </td>
