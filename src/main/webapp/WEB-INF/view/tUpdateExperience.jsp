...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <hr/>
            <!--横向导航结束-->
            <form:form action="tUpdateExperienceInfo${experience.experienceId}" method="post" commandName="experience" role="form">
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="objective" name="objective" value="${experience.objective}"/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="subjectAmount" name="subjectAmount" value="${experience.subjectAmount}"/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="period" name="period" value="${experience.period}"/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" class="form-control" id="begin" name="begin" value="${experience.begin}"/>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="date" class="form-control" id="deadline" name="deadline" value="${experience.deadline}"/>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
