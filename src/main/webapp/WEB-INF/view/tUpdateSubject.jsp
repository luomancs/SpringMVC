...
font-size: 16px;"> Last access : 30 May 2014 &nbsp; <a href="login.jsp" class="btn btn-danger square-btn-adjust">Logout</a> </div>
    ...
    <div id="page-wrapper" >
        <div id="page-inner">
            ...
            <hr/>
            <!--横向导航结束-->
            <form:form action="tUpdateSubjectInfo${subject.subjectId}" method="post" commandName="experience" role="form">
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            <td>1</td>
                                            <td>
                                                <label for="question">实验题目标题:</label>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="question" name="question" value="${subject.question}"/>
                                            </td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td>
                                                <label for="rightAnswer">实验答案</label>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="rightAnswer" name="rightAnswer" value="${subject.rightAnswer}"/>
                                            </td>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td>
                                                <label for="gist">实验批改要点</label>
                                            </td>
                                            <td>
                                                <input type="text" class="form-control" id="gist" name="gist" value="${subject.gist}"/>
                                            </td>
